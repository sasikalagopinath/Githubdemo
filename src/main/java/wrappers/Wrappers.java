...
public interface Wrappers {
	...
	/**
	 * This method will perform the TAB function
	 * @param Xpathval - 
	 * @param tab_key
	 */
	public void tabByXpath(String Xpathval, Keys tab_key);
	...
	/**
	 * Giving wait time to select/enter the value
	 * @param value
	 */
	...
	/**
	 * This method will select the drop down using value as xpathVal locator
	 * @param xpathVal The xpathVal (locator) of the drop down element
	 * @param value The value to be selected (Value) from the dropdown 
	 */
	...
	/**
	 * This methdwill perform the Page Down fuction
	 * @param xpathVal
	 * @param pagedown
	 */
	...
	/**
	 * This method will perfoem the get text using attribute value
	 * @param xpathVal
	 */
	public void getAttributeValueByXpath(String xpathVal);
	
	/**
	 * This method will perform the down function
	 * @param xpathVal
	 * @param down
	 */
